...
-- Saving an expense
-- ---------------------------------------------------------------------------
-- An expense and its shares must be written in ONE transaction, or the
-- deferred balance trigger above fires on a half-written expense. PostgREST
-- gives the browser no way to open a transaction, so the write lives here.
